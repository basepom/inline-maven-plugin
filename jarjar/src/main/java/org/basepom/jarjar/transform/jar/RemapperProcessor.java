...
import static org.basepom.jarjar.ClassNameUtils.ifClass;
import static org.basepom.jarjar.ClassNameUtils.pathToElements;
import static org.basepom.jarjar.ClassNameUtils.stripClassExtension;
...
public final class RemapperProcessor implements JarProcessor {
    ...
    Set<Rename> locateRenames(ClassPathResource resource) {
    ...
    public class InlineRemapper extends Remapper {
        ...
        private Set<Rename> locateRenamers(SetMultiTrie<String, ClassPathResource> trie, List<String> elements, ClassPathTag type) {
